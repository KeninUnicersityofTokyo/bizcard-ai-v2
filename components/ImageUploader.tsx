...
export default function ImageUploader({ onImageSelected }: ImageUploaderProps) {
    ...
    return (
        <div className="w-full max-w-xl mx-auto p-6 bg-white rounded-2xl shadow-sm border border-gray-200">
            ...
            <div className="relative aspect-video bg-gray-50 rounded-xl overflow-hidden border-2 border-dashed border-gray-300 flex items-center justify-center group hover:border-gray-400 transition-colors cursor-pointer">
                {preview ? (
                    <img
                        src={preview}
